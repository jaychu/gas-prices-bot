...
export const noteFromGasbot_noUpdate = "EnPro did not provide an updated prediction today, so we're operating under the assumption for now that no gas price will change today."